...
public class contextMenuCompleted {
    ...
    public void setupContextMenu(JList<String> jList, String fileName) {
        ...
        JMenuItem uncomplete = new JMenuItem("Unmark as complete");
        JMenuItem editItem = new JMenuItem("Edit");
        JMenuItem deleteItem = new JMenuItem("Delete");
   
        contextMenu.add(uncomplete);
        ...
        uncomplete.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                int selectedIndex = jList.getSelectedIndex();
                if (selectedIndex != -1) {
                    ...
                    completedModel.remove(selectedIndex);
